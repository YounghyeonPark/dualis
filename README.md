...
| `dualis-world` | The first consumer, and not published. Scenes described as data: built, coupled over the bus, run and drawn. It exists to use the SDK from outside and write down where that is awkward |
