...
what the library feels like from outside, and five of its eighteen findings are the same
...
python -m pip install --force-reinstall target/wheels/dualis-0.6.0-*.whl
