...
//! `pantometry-view` has its own for what the writers do with a sample that is not a number.

use pantometry_core::units::{Length, LengthVec, Temperature, Time};
use pantometry_core::{ScalarField, Substance};
