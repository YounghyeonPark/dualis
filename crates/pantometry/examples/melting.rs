...
use pantometry_molecular::{fcc_shells, RadialDistribution};
...
fn kelvin(reduced: f64) -> Temperature {
    pantometry_molecular::temperature_from_reduced(reduced, &LennardJones::reduced())
}
...
fn measure(label: &'static str, reduced_t: f64, density: f64, seed: u64) -> Sample {
    ...
    Sample {
        ...
        settled_t: pantometry_molecular::reduced_temperature(
