...
//! ```
//!
//! Two domains that have never heard of each other. `pantometry-optics` integrates a 100 W green
//! laser against a mirror's spectral absorptance and gets a real number of watts;
//! `pantometry-thermal` conducts them through aluminium. They meet over a boundary cut into
