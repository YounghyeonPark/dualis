...
//!
//! `pantometry-electrical`'s `Winding` states a resistance and dissipates `I²R`. That is exactly right
...
fn a_field_decays_in_a_conductor_at_the_exact_rate() {
    ...
    let epsilon = pantometry::em::EPSILON_0;
    let mu = pantometry::em::MU_0;
...
fn the_depth_carrying_the_current_shrinks_as_the_root_of_the_frequency() {
    ...
    let w = pantometry::electrical::Winding::of_copper(
        "coil",
        Length::m(10.0),
        1e-6,
