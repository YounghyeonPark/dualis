...
//!
//! `pantometry-optics` gives a slit's far field as `sinc²(π a sinθ/λ)`. That rests on **Kirchhoff's**
...
//!
//! So the two agree in a limit and not otherwise, and this measures where. `pantometry-em` marches the
