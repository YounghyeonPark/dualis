...
//!
//! This is the test the whole architecture was for. `pantometry-optics` computes how much
//! of a lamp a surface absorbs and publishes the joules; `pantometry-thermal` consumes
...
//! [`Exchange`](pantometry_core::Exchange) and nothing else.
//!
...
use pantometry_optics::spectrum::Spectrum as Spec;
