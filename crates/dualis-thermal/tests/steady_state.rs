...
use dualis_thermal::{Environment, ThermalNetwork, HEAT};
use dualis_units::{Area, Conductance, Length, Power, Temperature, Time, Volume};
...
fn ladder(substance: fn() -> Substance) -> (ThermalNetwork, [dualis_thermal::Node; 3], f64) {
...
fn one_node_agrees_with_the_lumped_equilibrium_rise() {
    ...
    let lump = dualis_thermal::LumpedMass::new(
        "plate",
