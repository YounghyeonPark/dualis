...
fn two_phase_ice() -> Substance {
    ...
    base.with_fusion(fusion.with_liquid(ThermalProps {
        conductivity: dualis_core::units::ThermalConductivity::w_per_m_k(K_L),
        specific_heat: dualis_core::units::SpecificHeat::j_per_kg_k(C_L),
        expansion: dualis_core::units::ThermalExpansion::ppm_per_k(207.0),
        emissivity: 0.96,
    }))
}
