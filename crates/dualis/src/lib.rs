...
//! consumer writes `dualis = "0.13"` rather than naming eleven crates, and that the
...
pub mod prelude {
    ...
    pub use dualis_core::mixture::Mix;
    ...
    pub use dualis_fluid::{Channel, Walls};
