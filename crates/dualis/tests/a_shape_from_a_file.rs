...
//!
//! This is the claim `dualis-shape` was built to make good: a mesh a person exported can drive the
...
//!
//! It also lives where it has to. `dualis-shape` depends on `dualis-units` and nothing else in the
...
use dualis::prelude::*;
use dualis::shape::{Mesh, Triangle, Voxels};
use dualis_core::{Domain, Exchange, Schedule};
use glam::DVec3;
