...
/// own [`audit`](dualis_core::audit) fell into — a correct system's net is often exactly
/// zero, which is why [`Ledger`](dualis_core::Ledger) records the largest contribution
