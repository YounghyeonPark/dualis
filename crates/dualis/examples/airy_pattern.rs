...
//!
//! Every number here comes from the Bessel series in `dualis-optics`, checked against the
...
use dualis::prelude::*;
use dualis_optics::diffraction::{airy_intensity, mtf_ideal, FIRST_AIRY_ZERO, SECOND_AIRY_ZERO};
