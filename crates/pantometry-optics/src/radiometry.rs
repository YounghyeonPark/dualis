...
//! `pantometry-units` where its dimensions can be checked.
//!
...
use pantometry_units::{Dimensionless, Frequency, Length, Power, Time, C, PLANCK};
...
mod tests {
    ...
    use pantometry_units::photon_energy;
