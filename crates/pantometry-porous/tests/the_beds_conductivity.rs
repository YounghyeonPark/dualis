...
//! Hashin–Shtrikman variational bound written as a bound, and it is checked in `pantometry-core` against
...
use pantometry_core::substance::{Substance, ThermalProps};
...
use pantometry_porous::{Basket, Liquid, Puck};
...
/// that is true of the continuum and false of a scheme — the two-phase work in `pantometry-thermal` found one
