...
//! until there was per-element material in `pantometry-elastic` there was nothing in this workspace a bound
...
//! elastic medium — in `crates/pantometry-elastic/tests/a_layered_wave.rs`, and the harmonic end again
